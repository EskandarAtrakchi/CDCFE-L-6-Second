...
class cas{
    ...
    static NFT java = new NFT("Java Text", getFileContents("java-text"),
        20, 10, false);
    static NFT jikjikoplu = new NFT("Jikjikoplu Logo",
        getFileContents("jikjikoplu"), 50, 25, false);
    static NFT customNFT = new NFT("Custom NFT",
        "Use 'Make an NFT' to unlock me!", 10, 0, false);
    static NFT[] nftList = {sword, java, jikjikoplu, customNFT};
    // --Other--
     ...
     * uppercase.
     * <p>
     * @param endClearScreen - Wether or not the invoke clearScreen()
