...
public class SQL {
    ...
    */
    ...
    public static void loginVerificationforCustomer() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:sqlite:C:/DB/DB.db")){  
            ...
            if (rsForID.next() && rsForPassWord.next()) {
                ...
                JOptionPane.showMessageDialog(null, "Hmmm... seems you haven't typed the right info, you can try again!"); 
    ...
    public static void view() {
        ...
        Customers.jTextArea1.setText(null); // blank the text area

        // Get column names and initialize max length variables
        String[] columns = {"ID", "Name", "Cpacity", "Color",
                            "Price", "Condition", "Size", "YearModel"};
        int[] maxLengths = new int[columns.length];
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            Customers.jTextArea1.append("Stock details, click on update button to refresh.\n\n" + " " + sb.toString().trim() 
                    + "\n" + "=================================================================="
                        + "===============================\n");
            ...
            while (rs.next()) {
                ...
                Customers.jTextArea1.append(sb.toString().trim() + "\n" + 
                        "=================================================================="
                        + "===============================\n");
            }
    ...
    public static void HelpBTNForCustomers () {
            
        if (Customers.jTextArea2.getText().equals("")) { 

            JOptionPane.showMessageDialog(null,"Please, write the issue before you click on send button.");
        ...
        Customers.jTextArea2.setText("");
            
    }
    
    //this method is for NewFrameHelp
    
    public static void NewFrameHelp() {
            
        if (NewJFrameHelp.NewFrameHelpTextArea.getText().equals("")) { 
        ...
        NewJFrameHelp.NewFrameHelpTextArea.setText("");
    ...
    public static void deleteUser() {
        ...
        String ID = CustomerFirstFrame.UserFFIDF.getText();
    ...
    public static void ConfirmToPurchase() {
        ...
        JOptionPane.showMessageDialog(null, "You have purchased the vehicle successfully!");
        Customers.jTextArea3.setText(null);
